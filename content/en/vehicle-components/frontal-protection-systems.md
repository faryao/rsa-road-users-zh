...
[Is it illegal to fit a bull bar on a vehicle?](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
[What is meant by a type-approved bull bar?](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
[My bull bar is e-marked but how do I know if it can be legally fitted to my model of vehicle?](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
[Where can I get a modifications report?](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
Did you find this information useful?[Yes](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)[No](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
[View the current official RSA page](https://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars))
