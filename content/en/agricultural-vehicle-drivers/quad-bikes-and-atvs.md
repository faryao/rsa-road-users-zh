...
![Image 3](http://www.rsa.ie/images/default-source/in-page-full-width-(868-x-487)/quad-image-(1).jpg?Status=Master&sfvrsn=2c585d80_3)
## Using a quad bike on a public road
...
If used on a public road, which includes a footpath, quads are subject to all of the regulatory controls that apply to other mechanically propelled vehicles (MPVs) i.e., they must be roadworthy, registered, taxed and comply with all regulations listed below.
...
[What is a quad bike?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)

A quad bike or all-terrain vehicle (ATV) is a four-wheel powered vehicle which is generally designed for off-road use e.g., farms, purpose-built tracks etc.

[Can I drive a quad on public road?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)

If used on a public road, quads are subject to all of the regulatory controls that apply to other mechanically propelled vehicles (MPVs) i.e., must be roadworthy, registered, taxed and comply with all regulations mentioned below.

[What road traffic laws apply to quads?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)
...
[Is a licence required to drive a quad bike on the public road?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)
...
[Is a seat belt required on a quad?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)
...
[Is it illegal to carry children on a public road in a quad towing a trailer?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)
...
[My quad is for off-road use only, can I use the public road to get from one field to another?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)

If used on a public road, quads are subject to all of the regulatory controls that apply to other mechanically propelled vehicles as mentioned above. However, enforcement of these regulations is a matter for An Garda Síochána so ultimately the discretion lies with them.

[Can I drive off-road quad tyres on the public road?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)

Tyres fitted to a vehicle being used on the road require type-approval i.e. e-marked, s-marked and have a minimum 1.6 mm tread depth. If off-road tyres meet with these requirements, then they can be used on a public road. Some off-road tyres are marked ‘for off-road use only’ and may not be used on a public road. You can also refer to our booklet [Tyre Safety Information Guide.](http://www.rsa.ie/docs/default-source/road-safety/r1.4-car-drivers/tyre-safety-booklet2b07b842a4884313b177695d063b776c.pdf?sfvrsn=3ec80cfb_28)

[I only use quad on farm. Does it need tax and insurance etc.?](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)

No.

Did you find this information useful?[Yes](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)[No](http://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes#)
...
[View the current official RSA page](https://www.rsa.ie/road-safety/road-users/agricultural/quad-bikes)
