...
不可以。但是，批准进入欧洲市场的车辆只能配备经过类型批准的正面保护系统或防撞杆，这包括制造后的任何修改。在某些情况下，旧车辆可能会安装未经批准的防撞杆。然而，根据爱尔兰道路交通法规，安装非必要的突出物是非法的，对车辆进行任何可能造成危险的改装也是非法的。
...
[型式认可的牛栏是什么意思？](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)

经批准的防撞杆带有“E”或“e”标记，原始制造商已声明它可以安装到您特定的车辆品牌和型号。

[我的防撞杆带有电子标记，但我如何知道它是否可以合法安装到我的车型上？](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
如果您对车辆加装防撞杆，则视为改装，因此您可能需要在车辆的下一次道路适航性测试中提供改装报告。该修改报告应由原始制造商或授权经销商或适当的合格人员（即机械工程师）进行认证。

[哪里可以得到改装报告？](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
可以，但前提是原始制造商批准将其安装到您的车辆上。您可能会被要求出示书面证明才能通过道路适航性测试。
...
您觉得这些信息有用吗？[是](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)

[否](http://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars)#)
...
[查看当前RSA官方页面](https://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars))

---

[查看 RSA 当前官方页面](https://www.rsa.ie/road-safety/road-users/vehicle-components/frontal-protection-systems-(bull-bars))
