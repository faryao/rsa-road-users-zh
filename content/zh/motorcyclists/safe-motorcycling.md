...
世界各地数百万训练有素的摩托车手每天都证明，骑自行车可以是一项有趣、安全和令人愉快的活动。接受正确的培训、养成良好的习惯和定期的复习培训将有助于确保您、您的乘客和其他道路使用者的安全。

![图片1：rsz_motorcycle](https://www.rsa.ie/images/default-source/dummy-content/example-gallery/rsz_motorcycle.jpg)
...
随着经验和技术水平的提高，经验丰富的摩托车手必须防止自满，避免骑行到他们技术的极限。请记住，在公共道路上行驶时，您必须在法定速度限制内行驶，并特别注意当时的道路和交通状况。
...
* 头盔应紧密贴合并正确紧固。
* 面罩应干净、清晰。
* 夹克和裤子应为您提供足够的保护，免受冲击、磨损、寒冷和天气条件的影响。
* 在背部、膝盖、肘部、肩膀、臀部和小腿等易受伤害的部位使用经批准的防弹衣。
* 装甲应该是可调节的，因此它可以紧密贴合并且不会在受到冲击时移动。
* 穿着一件醒目的夹克可以让自己在路上更加引人注目。
* 佩戴经认可的防护手套。

* 穿着经过认可的、长度在脚踝以上的摩托车靴。

* 保持警惕。在改变位置或转弯之前，使用镜子观察远距离、中距离和近处，并检查肩膀（救生员）。

* 保持距离。在恶劣的天气条件下，始终与前方车辆之间保持更大的距离。

* 被看见。确保您的位置正确，使用近光灯并穿着能见度高的衣服。
* 避免让其他道路使用者感到惊讶。切勿在道路上做任何可能导致他人减速、刹车、转向或可能惊吓行人的事情。

* 像其他道路使用者一样思考。预测他们对您和其他道路使用者的反应。

* 阅读道路并根据当前道路、天气和交通状况骑行。

* 根据情况调整你的速度，不要让别人决定你的速度。
...
2. 一名摩托车手在超车时与迎面驶来的车辆迎面相撞。

3. 摩托车手在拐角/弯道时失去控制并进入迎面驶来的车辆的路径，导致正面碰撞。
...
[查看 RSA 当前官方页面](https://www.rsa.ie/road-safety/road-users/motorcyclists/safe-motorcycling)
